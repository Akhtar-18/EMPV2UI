                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="profile-tabs d-flex justify-content-between flex-wrap mt-1 mt-md-0">
                      <ul class="nav nav-pills mb-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold active" id="general-tab" data-toggle="pill" href="#home" aria-expanded="true">
                                <span class="d-none d-md-block">General</span>
                              <i data-feather="home" class="d-block d-md-none"></i>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="leave-tab" data-toggle="pill" href="#leave" aria-expanded="false">Profile</a>
                          </li>
                          <!-- Dropdown -->
